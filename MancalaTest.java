...
public class MancalaTest
{
	public static void main(String [] args)
	{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				label.addMouseListener(new MouseAdapter()
				{
			         public void mouseClicked(MouseEvent e) 
			         {
			        	 ...
			        	 //get y value; check which side is on
			        	 //check if user 1 or user 2
			        	 //if not match, cannot pass in number
			        	 //if match check in range (not in mancala)
			        	 //then check which pit it is in
			         }                
			    });
		...
		//frame.add(textStyle, BorderLayout.NORTH);
